...
#define _ext_rtc_get_time(args)	pmic_rtc_get_time(args)
#define _ext_rtc_set_time(args)	pmic_rtc_set_time(args)
#define _ext_rtc_loaded()	pmic_rtc_loaded()
#elif defined(CONFIG_ISL1208_RTC)
extern int isl1208_rtc_get_time(struct timeval *time);
extern int isl1208_rtc_set_time(struct timeval *time);
extern int isl1208_rtc_loaded(void);
#define _ext_rtc_get_time(args)	isl1208_rtc_get_time(args)
#define _ext_rtc_set_time(args)	isl1208_rtc_set_time(args)
#define _ext_rtc_loaded()	isl1208_rtc_loaded()
#else
#define _ext_rtc_get_time(args)	MXC_EXTERNAL_RTC_NONE
#define _ext_rtc_set_time(args)	MXC_EXTERNAL_RTC_NONE
#define _ext_rtc_loaded()	0
#endif
